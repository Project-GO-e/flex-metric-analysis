...
if __name__ == "__main__":
    ...
    load_filter = ExperimentFilter().with_area('6651').with_flex_window_duration(48).with_cong_durations([24])
    ...
    data = all_experiments.get_mean_flex_for_time_of_day(DeviceType.EV, ['6651'], 48)
    ...
    data, metadata = all_experiments.get_mean_flex_for_congestion_start(DeviceType.EV, ['6651'], 48, 24)
